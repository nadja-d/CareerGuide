...
public class PartnerUpdateCourse extends javax.swing.JFrame {
        Connection myConnection = null; ResultSet myResultSet = null; PreparedStatement myPreparedStatement = null;

    public PartnerUpdateCourse() {
        initComponents();
        myConnection = db.myConnector();
    }
    
    PartnerUpdateCourse(String course, String company) {
        this();
        
        jName.setText(course);
        jCompany.setText(company);
        jCompany.setEditable(false);
        
        try {
            String SQLQuery = "SELECT * FROM catalogue WHERE course='" + course + "' AND company='" + company + "';";
            myPreparedStatement = myConnection.prepareCall(SQLQuery);
            myResultSet = myPreparedStatement.executeQuery();
            if (myResultSet.next()) {
                jInstructor.setText(myResultSet.getString("Instructor"));
                jPlatform.setText(myResultSet.getString("Platform"));
                jTopic.setText(myResultSet.getString("Topic"));   
                jTopic.setEditable(false);
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
            ...
            try {
            Statement myStatement = db.myConnector().createStatement();
            myStatement.executeUpdate("UPDATE catalogue SET course = '"+nameText+"', instructor = '"+instructorText+"', platform = '"+platformText+"' WHERE company = '"+companyText+"'");
            } catch (SQLException e) {System.out.println(e);}            
            
            String Message = "The course, " + nameText + " by " + companyText + " has been updated";
            String Title = "Successful Update";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PartnerUpdateCourse().setVisible(true);
            }
        });
    }
