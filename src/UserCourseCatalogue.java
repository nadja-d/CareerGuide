...
public class UserCourseCatalogue extends javax.swing.JFrame {
        Connection myConnection = null; ResultSet myResultSet = null;
        Statement myStatement = null;

    public UserCourseCatalogue() {
        initComponents();
    ...
    public void viewTable() { 
        ...
        while (myResultSet.next()){
            ...
            String companyName = myResultSet.getString("Company");

            Object[] rowData = {courseName, companyName};
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Catalogue of Courses");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        this.setVisible(false); new UserDetailCourse(course, company).setVisible(true);        
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserCourseCatalogue().setVisible(true);
            }
        });
    }
